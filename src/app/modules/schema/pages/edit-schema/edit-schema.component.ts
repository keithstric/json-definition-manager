...
import {IPropertyDefinition, ISchema} from '@shared/interfaces/map.interface';
...
export class EditSchemaComponent implements OnInit, OnDestroy {
	...
	schema: any;
	currentSchema: any;
	definition: IPropertyDefinition[] = [{path: null, description: null, type: null, childSchema: null, required: false, comments: null}];
	currentDefinition: IPropertyDefinition[] = [];
	docId: string;
